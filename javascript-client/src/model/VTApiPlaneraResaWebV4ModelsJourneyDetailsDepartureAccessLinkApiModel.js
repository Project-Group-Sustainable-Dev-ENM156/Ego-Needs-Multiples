...
/**
 * The VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel model module.
 * @module model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel
 * @version v4
 */
class VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel {
    /**
     * Constructs a new <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel</code>.
     * Information about a walk, bike or car link from origin to first public transport trip leg.
     * @alias module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel
     */
    constructor() { 
        
        VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel} obj Optional instance to populate.
     * @return {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel} The populated <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel();
    ...
    /**
     * Validates the JSON data with respect to <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel</code>.
     */
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['transportMode'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsTransportSubMode} transportSubMode
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['transportSubMode'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel} origin
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['origin'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel} destination
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['destination'] = undefined;
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['notes'] = undefined;

/**
 * Distance in meters.
 * @member {Number} distanceInMeters
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['distanceInMeters'] = undefined;

/**
 * The planned departure time in RFC 3339 format.
 * @member {String} plannedDepartureTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['plannedDepartureTime'] = undefined;

/**
 * The planned arrival time in RFC 3339 format.
 * @member {String} plannedArrivalTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['plannedArrivalTime'] = undefined;

/**
 * The planned duration in minutes.
 * @member {Number} plannedDurationInMinutes
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['plannedDurationInMinutes'] = undefined;

/**
 * The estimated departure time in RFC 3339 format, if available.
 * @member {String} estimatedDepartureTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['estimatedDepartureTime'] = undefined;

/**
 * The estimated arrival time in RFC 3339 format, if available.
 * @member {String} estimatedArrivalTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['estimatedArrivalTime'] = undefined;

/**
 * The estimated duration in minutes, if available.
 * @member {Number} estimatedDurationInMinutes
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['estimatedDurationInMinutes'] = undefined;

/**
 * Number of steps based on the distance and an estimated step length of 0.65 meters.
 * @member {Number} estimatedNumberOfSteps
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['estimatedNumberOfSteps'] = undefined;

/**
 * The coordinates for the link.
 * @member {Array.<module:model/VTApiPlaneraResaWebV4ModelsCoordinateApiModel>} linkCoordinates
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['linkCoordinates'] = undefined;
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel.prototype['segments'] = undefined;
...
export default VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel;
