...
/**
 * The VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel model module.
 * @module model/VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel
 * @version v4
 */
class VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel {
    /**
     * Constructs a new <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel</code>.
     * Information about a walk, bike or car link from last public transport trip leg to destination.
     * @alias module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel
     */
    constructor() { 
        
        VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel} obj Optional instance to populate.
     * @return {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel} The populated <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel();
    ...
    /**
     * Validates the JSON data with respect to <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel</code>.
     */
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['transportMode'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsTransportSubMode} transportSubMode
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['transportSubMode'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel} origin
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['origin'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel} destination
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['destination'] = undefined;
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['notes'] = undefined;

/**
 * Distance in meters.
 * @member {Number} distanceInMeters
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['distanceInMeters'] = undefined;

/**
 * The planned departure time in RFC 3339 format.
 * @member {String} plannedDepartureTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['plannedDepartureTime'] = undefined;

/**
 * The planned arrival time in RFC 3339 format.
 * @member {String} plannedArrivalTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['plannedArrivalTime'] = undefined;

/**
 * The planned duration in minutes.
 * @member {Number} plannedDurationInMinutes
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['plannedDurationInMinutes'] = undefined;

/**
 * The estimated departure time in RFC 3339 format, if available.
 * @member {String} estimatedDepartureTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['estimatedDepartureTime'] = undefined;

/**
 * The estimated arrival time in RFC 3339 format, if available.
 * @member {String} estimatedArrivalTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['estimatedArrivalTime'] = undefined;

/**
 * The estimated duration in minutes, if available.
 * @member {Number} estimatedDurationInMinutes
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['estimatedDurationInMinutes'] = undefined;

/**
 * Number of steps based on the distance and an estimated step length of 0.65 meters.
 * @member {Number} estimatedNumberOfSteps
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['estimatedNumberOfSteps'] = undefined;

/**
 * The coordinates for the link.
 * @member {Array.<module:model/VTApiPlaneraResaWebV4ModelsCoordinateApiModel>} linkCoordinates
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['linkCoordinates'] = undefined;
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.prototype['segments'] = undefined;
...
export default VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel;
