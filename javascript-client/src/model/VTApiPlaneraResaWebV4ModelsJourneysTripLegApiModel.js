...
import VTApiPlaneraResaWebV4ModelsJourneysPadamUrlsApiModel from './VTApiPlaneraResaWebV4ModelsJourneysPadamUrlsApiModel';
...
class VTApiPlaneraResaWebV4ModelsJourneysTripLegApiModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('padamUrls')) {
                obj['padamUrls'] = VTApiPlaneraResaWebV4ModelsJourneysPadamUrlsApiModel.constructFromObject(data['padamUrls']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `padamUrls`
        if (data['padamUrls']) { // data not null
          VTApiPlaneraResaWebV4ModelsJourneysPadamUrlsApiModel.validateJSON(data['padamUrls']);
        }
...
/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneysPadamUrlsApiModel} padamUrls
 */
VTApiPlaneraResaWebV4ModelsJourneysTripLegApiModel.prototype['padamUrls'] = undefined;
