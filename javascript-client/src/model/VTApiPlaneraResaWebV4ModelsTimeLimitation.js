...
/**
* Enum class VTApiPlaneraResaWebV4ModelsTimeLimitation.
* @enum {}
* @readonly
*/
export default class VTApiPlaneraResaWebV4ModelsTimeLimitation {
    ...
    /**
    * Returns a <code>VTApiPlaneraResaWebV4ModelsTimeLimitation</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VTApiPlaneraResaWebV4ModelsTimeLimitation} The enum <code>VTApiPlaneraResaWebV4ModelsTimeLimitation</code> value.
    */
