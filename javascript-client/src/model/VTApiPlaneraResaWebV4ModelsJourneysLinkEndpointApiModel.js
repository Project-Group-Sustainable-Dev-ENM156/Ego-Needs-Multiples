 ...
 * @version v4
 */
class VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel.RequiredProperties) {
            if (!data[property]) {
...
export default VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel;
