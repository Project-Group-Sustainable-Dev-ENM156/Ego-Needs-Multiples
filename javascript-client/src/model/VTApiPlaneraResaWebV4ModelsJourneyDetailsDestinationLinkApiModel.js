...
import VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel from './VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel';
...
/**
 * The VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel model module.
 * @module model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel
 * @version v4
 */
class VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel {
    /**
     * Constructs a new <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel</code>.
     * Information about a walk, bike or car link from origin to destination.
     * @alias module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel
     */
    constructor() { 
        
        VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel} obj Optional instance to populate.
     * @return {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel} The populated <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel();
            ...
            if (data.hasOwnProperty('origin')) {
                obj['origin'] = VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.constructFromObject(data['origin']);
            }
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.constructFromObject(data['destination']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel</code>.
     */
    static validateJSON(data) {
        // validate the optional field `origin`
        if (data['origin']) { // data not null
          VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.validateJSON(data['origin']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.validateJSON(data['destination']);
        }
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['transportMode'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsTransportSubMode} transportSubMode
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['transportSubMode'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel} origin
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['origin'] = undefined;

/**
 * @member {module:model/VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel} destination
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['destination'] = undefined;
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['notes'] = undefined;

/**
 * Distance in meters.
 * @member {Number} distanceInMeters
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['distanceInMeters'] = undefined;

/**
 * The planned departure time in RFC 3339 format.
 * @member {String} plannedDepartureTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['plannedDepartureTime'] = undefined;

/**
 * The planned arrival time in RFC 3339 format.
 * @member {String} plannedArrivalTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['plannedArrivalTime'] = undefined;

/**
 * The planned duration in minutes.
 * @member {Number} plannedDurationInMinutes
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['plannedDurationInMinutes'] = undefined;

/**
 * The estimated departure time in RFC 3339 format, if available.
 * @member {String} estimatedDepartureTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['estimatedDepartureTime'] = undefined;

/**
 * The estimated arrival time in RFC 3339 format, if available.
 * @member {String} estimatedArrivalTime
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['estimatedArrivalTime'] = undefined;

/**
 * The estimated duration in minutes, if available.
 * @member {Number} estimatedDurationInMinutes
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['estimatedDurationInMinutes'] = undefined;

/**
 * Number of steps based on the distance and an estimated step length of 0.65 meters.
 * @member {Number} estimatedNumberOfSteps
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['estimatedNumberOfSteps'] = undefined;

/**
 * The coordinates for the link.
 * @member {Array.<module:model/VTApiPlaneraResaWebV4ModelsCoordinateApiModel>} linkCoordinates
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['linkCoordinates'] = undefined;
 ...
 */
VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.prototype['segments'] = undefined;
...
export default VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel;
