...
export default class LocationsApi {
    ...
    */
     ...
     * @param {Number} [radiusInMeters = 500)] The search radius from the coordinates specified in meters. Must be a positive integer > 0.
     * @param {Array.<module:model/VTApiPlaneraResaWebV4ModelsLocationByCoordinatesType>} [types] The location types to include in the response, if none specified all locations types are included.
     * @param {Number} [limit = 10)] The number of results to return.
     * @param {Number} [offset = 0)] The zero-based start offset of the pagination.
     * @param {Boolean} [bodSearch = false)] Show BoD stops in result
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/VTApiPlaneraResaWebV4ModelsLocationByTextType>} [types] The location types to include in the response, if none specified all locations types are included.
     * @param {Number} [limit = 10)] The number of results to return.
     * @param {Number} [offset = 0)] The zero-based start offset of the pagination.
     * @param {Boolean} [bodSearch = false)] Show BoD stops in result
     * @param {Number} [latitude] Search coordinate. Gives priority to geographically closer results.
     * @param {Number} [longitude] Search coordinate. Gives priority to geographically closer results.
