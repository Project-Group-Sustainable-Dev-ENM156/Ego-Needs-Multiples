...
export default class PositionsApi {
    ...
    */
     ...
     * @param {Array.<module:model/VTApiPlaneraResaCoreModelsPositionTransportMode>} [transportModes] The transport modes to include when searching for journeys, if none specified all transport modes are included.
     * @param {Array.<String>} [detailsReferences] Filter journeys by one or more journey details reference.
     * @param {Array.<String>} [lineDesignations] Only journeys running the given lineDesignations (case sensitive) are part of the result.
     * @param {Number} [limit = 100)] Maximum number of journeys in response. Range from 1 to 200. Defaults to 100
