...
export default class StopAreasApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the stopAreasGet operation.
     * @callback module:api/StopAreasApi~stopAreasGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/VTApiPlaneraResaWebV4ModelsStopAreasStopAreaApiModel>} data The data returned by the service call.
     ...
     * @param {module:api/StopAreasApi~stopAreasGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/VTApiPlaneraResaWebV4ModelsStopAreasStopAreaApiModel>}
     */
    stopAreasGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = [VTApiPlaneraResaWebV4ModelsStopAreasStopAreaApiModel];
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/VTApiPlaneraResaWebV4ModelsArrivalDetailsIncludeType>} [includes] The additional information to include in the response.
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} [startDateTime] The start of the time interval for which to get upcoming arrivals. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.
     * @param {String} [platforms] Filter results by platform. Multiple platforms are separated by comma. Case sensitive.
     * @param {Number} [timeSpanInMinutes = 60)] The number of minutes from the start time for which to get upcoming arrivals. Allowed values are between 0 and 1440.
     * @param {Number} [maxArrivalsPerLineAndDirection = 2)] The maximum number of arrivals for a single line in a specific direction.
     * @param {Number} [limit = 10)] The number of results to return.
     * @param {Number} [offset = 0)] The zero-based start offset of the pagination.
     * @param {String} [directionGid] Filter result by last stop on journey. Must be a 16-digit Västtrafik stop area
    ...
    stopAreasStopAreaGidArrivalsGet(stopAreaGid, opts, callback) {
      ...
      let queryParams = {
        ...
        'limit': opts['limit'],
        'offset': opts['offset'],
        'directionGid': opts['directionGid']
      };
      let headerParams = {
      };
      let formParams = {
     ...
     * @param {String} stopAreaGid 
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/VTApiPlaneraResaWebV4ModelsDepartureDetailsIncludeType>} [includes] The additional information to include in the response.
     ...
     * @param {String} stopAreaGid The 16-digit Västtrafik gid of the stop area.
     * @param {Object} opts Optional parameters
     * @param {Date} [startDateTime] The start of the time interval for which to get upcoming departures. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.
     * @param {String} [platforms] Filter results by platform. Multiple platforms are separated by comma. Case sensitive.
     * @param {Number} [timeSpanInMinutes = 60)] The number of minutes from the start time for which to get upcoming departures. Allowed values are between 0 and 1440.
     * @param {Number} [maxDeparturesPerLineAndDirection = 2)] The maximum number of departures for a single line in a specific direction.
     * @param {Number} [limit = 10)] The number of results to return.
     * @param {Number} [offset = 0)] The zero-based start offset of the pagination.
     * @param {Boolean} [includeOccupancy = false)] Includes occupancy in departure.
     * @param {String} [directionGid] Filter result by last stop on journey. Must be a 16-digit Västtrafik stop area
