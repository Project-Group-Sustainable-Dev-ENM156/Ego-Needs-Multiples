...
export default class StopPointsApi {
    ...
    */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [startDateTime] The start of the time interval for which to get upcoming arrivals. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.
     ...
     * @param {String} stopPointGid The 16-digit Västtrafik gid of the stop point.
     * @param {Object} opts Optional parameters
     * @param {String} [startDateTime] The start of the time interval for which to get upcoming departures. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.
